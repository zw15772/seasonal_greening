...
def array2raster_GDT_Byte(newRasterfn,longitude_start,latitude_start,pixelWidth,pixelHeight,array, projection=4326):
    cols = array.shape[1]
    rows = array.shape[0]
...
def array2raster(newRasterfn,longitude_start,latitude_start,pixelWidth,pixelHeight,array,ndv = -999999,projection=4326):
    cols = array.shape[1]
    rows = array.shape[0]
    originX = longitude_start
    originY = latitude_start
